      ...
      <body className="min-h-dvh bg-slate-950 text-slate-100">
        <main className="flex min-h-dvh items-center justify-center px-4 py-12">
          <div className="w-full max-w-2xl rounded-2xl border border-slate-800 bg-slate-900 p-8 text-center shadow-2xl sm:p-12">
            ...
            <p className="font-mono text-xs tracking-[0.25em] text-rose-300 uppercase">Erro inesperado</p>
            <h1 className="mt-3 text-3xl font-semibold sm:text-4xl">Algo deu errado</h1>
            <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-400">
              Não foi possível carregar esta página. Tente novamente ou volte ao início.
            </p>
            {error.digest ? <p className="mt-5 text-xs text-slate-500">Referência: {error.digest}</p> : null}
