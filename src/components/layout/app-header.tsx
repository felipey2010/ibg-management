...
export function AppHeader() {
  return (
    <header className="border-border bg-background/95 sticky top-0 z-20 flex h-16 items-center gap-3 border-b px-4 backdrop-blur sm:px-6 lg:ml-64 lg:px-8">
      <MobileNavigation />
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <button
          type="button"
          aria-label="Abrir menu de Débora Ferreira"
          className="border-border bg-surface-elevated ml-1 flex size-8 items-center justify-center rounded-full border text-xs font-semibold"
        >
          DF
        </button>
      </div>
